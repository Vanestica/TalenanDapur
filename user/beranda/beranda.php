...
<body style="background-color:rgb(247,247,247); font-family:segoe ui">
...
<div class="container">
					...
					?>
						<a href="../itemdetil/itemdetil.php?kodeitem=<?= $a[0]; ?>">
							...
							<div class="card kotak1">
								...
								<div style="border:none ;height: 90px;width: 98px;padding: 2pt">
								...
								<div style="line-height: 12pt">
									...
									<input type="text" name="satuan" value="<?php echo $a[10];?>" style="border: none;width: 90%;float: left;" readonly class="kuantitasitem"><br>
									<input type="text" value="Rp." class="hargaitem" style="width: 23%;border: none;float: left">
									<input type="text" value="<?php echo number_format($a[7]);?>" style="border: none;width: 70%;float: left;" readonly class="hargaitem">
									<input type="text" name="harga" value="<?php echo $a[7];?>" style="border: none;width: 70%;float: left;" readonly hidden class="hargaitem">
								</div>
							</div>
						</a>
						<?php }?>
	...
	<div class="row">
		<div class="ko1" style="padding-bottom:20px;">
			...
			<div class="col">
				<input type="text" class="form-control" placeholder="Masukkan kode voucher" style="border-radius: 3pt;width: 60%;border: 1pt solid #AEAEAE;float:left;margin-top:10px;">
