...
<div style="border: none;width: 50%;float: left;height: 100%;padding: 5pt;">
	<div style="border: 1pt solid #AEAEAE;border-radius:3pt ;width: 100%;height: 100%;padding:5pt;">
		<div style="border: none;width: 100%;height: 110PX;">
			<img src="../image/manado.jpg" style="width: 100%;height: 100%">
    		<!-- <img src="data:image/jpeg; base64, <?php //echo base64_encode($foto); ?>" id="image" name="image" style="width: 100%;height: 100%;"> -->
    	</div>
    			<div class="main">
		  			<button style="border: none;background-color: transparent;color: red;margin-left: -12px;float: right;position: relative;top: -110px;" href="javascript:void(0)" onclick="del(<?php echo "'$h[1]'";?>)" style="color:red;" id="save" name="save" value="save">
		   	 		<i class="fa fa-heart"></i></button>
				</div>
				<div id="kodeitem" hidden></div>
				<div class="judulitem">
					<span id="namaitem"><?php echo $h[3];?></span>
				</div>
				<div class="kuantitasitem">
					<span id="kuantitas"><?php echo $h[6]; ?></span>
					<span id="satuan"><?php echo $h[7]; ?></span>
				</div>
				<div class="hargaitem">
					<span>Rp. <?php echo number_format($h[4]);?></span>
				</div>
