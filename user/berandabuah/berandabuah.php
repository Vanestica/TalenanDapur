...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="berandabuah.css">
  <meta charset="utf-8">
...
<div class="wilayahsortir">
	...
	<div class="kotaksortir" style="margin:0 10.5px">
		<a href="../berandabuah/berandabuah.php">
			...
			<p class="namasortir aktif2">Buah</p>
  		</a>
	</div>
	<div class="kotaksortir">
...
<div class="kotaksp">
	<div class="warnaorange">
		...
		<a href="../moresp3/moresp3.php"><span class="floatkanan">More...</span></a>
	</div>
	
	<div class="wilayahjualan">
		<div class="card kotak1">
			<img class="card-img-top" src="../image/buahnaga.jpg" alt="Card image">
		...
		<div class="card kotak1">
			<img class="card-img-top" src="../image/apelfuji.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Apel Fuji</span>
...
<div class="kotakspesifik">
	<div class="wilayahjualan">
		<div class="card kotak2">
			<img class="card-img-top" src="../image/alpukat.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Alpukat</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/kiwi.png" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Kiwi</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/sawo.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Sawo</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/langsat.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Langsat</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/pisangambon.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Pisang Ambon</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/rambutan.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Rambutan</span>
