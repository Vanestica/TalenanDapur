...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="berandadaging.css">
  <meta charset="utf-8">
...
<div class="wilayahsortir">
	...
	<div class="kotaksortir">
		<a href="../berandadaging/berandadaging.php">
			...
			<p class="namasortir aktif2">Daging</p>
  		</a>
	</div>
	<div class="kotaksortir" style="margin:0 10.5px">
...
<div class="kotaksp">
	<div class="warnaorange">
		...
		<a href="../moresp5/moresp5.php"><span class="floatkanan">More...</span></a>
	</div>
	
	<div class="wilayahjualan">
		<div class="card kotak1">
			<img class="card-img-top" src="../image/cekerayam.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Ceker Ayam</span>
				</div>
		...
		<div class="card kotak1">
			<img class="card-img-top" src="../image/sayapayam.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Sayap Ayam</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
...
<div class="kotakspesifik">
	<div class="wilayahjualan">
		<div class="card kotak2">
			<img class="card-img-top" src="../image/ikantenggiri.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Ikan Tenggiri</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/telurayam.png" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/ikanbandeng.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Ikan Bandeng</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/ikanbawal.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Ikan Bawal</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/pahaayam.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Paha Ayam</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/dadaayam.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Dada Ayam</span>
