	...
	<div class="bc">
		<div class="bc1">
			...
			<div class="b1">
				...
				<label class="b2">Steven C.F.L <a href="" class="b3">
			...
			<div class="b1">
				...
				<label class="b2" style="top: -45px;">steven@gmail.com <a href="" class="b3"><span class="fa fa-pen"></span></a></label>
			</div>
			<div class="b1" style="top: -50px;position: relative;">
				<p style="font-weight: bold;font-size: 15px;width: 50%;">Alamat</p>
				<label class="b2" style="height: 120px;">Jl. Siaga<a href="" class="b3">
				<span class="fa fa-pen"></span></a></label>
			</div>
			<div class="b1" style="top: -50px;position: relative;">
				<p style="font-weight: bold;font-size: 15px;width: 50%;">Telepon</p>
				<label class="b2">0812456789<a href="" class="b3">
				<span class="fa fa-pen"></span></a></label>
			</div>
			<div>
				<a href="" class="bl">
