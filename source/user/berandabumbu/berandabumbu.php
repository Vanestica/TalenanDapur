...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="berandabumbu.css">
  <meta charset="utf-8">
...
<div class="wilayahsortir">
	...
	<div class="kotaksortir" style="margin:0 10.5px">
		<a href="../berandabumbu/berandabumbu.php">
			...
			<p class="namasortir aktif2">Bumbu</p>
  		</a>
	</div>
</div>
...
<div class="kotaksp">
	<div class="warnaorange">
		...
		<a href="../moresp4/moresp4.php"><span class="floatkanan">More...</span></a>
	</div>
	
	<div class="wilayahjualan">
		<div class="card kotak1">
			<img class="card-img-top" src="../image/jahe.jpg" alt="Card image">
		...
		<div class="card kotak1">
			<img class="card-img-top" src="../image/lengkuas.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Lengkuas</span>
...
<div class="kotakspesifik">
	...
	<div class="wilayahjualan">
		<div class="card kotak2">
			<img class="card-img-top" src="../image/kunyit.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Kunyit</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/serai.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Serai</span>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/daunpandan.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Daun Pandan</span>
				</div>
				<div class="kuantitasitem">
					<span>1 helai</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/daunjeruk.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Daun Jeruk</span>
				</div>
				<div class="kuantitasitem">
					<span>1 helai</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/cabaikering.png" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Cabai Kering</span>
				</div>
				<div class="kuantitasitem">
					<span>1 ons</span>
				</div>
		...
		<div class="card kotak2">
			<img class="card-img-top" src="../image/ketumbar.jpg" alt="Card image">
				<div class="top-right"><i class="far fa-heart" aria-hidden="true"></i></div>
			<div>
				<div class="judulitem">
					<span>Ketumbar</span>
