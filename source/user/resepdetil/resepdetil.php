...
?>
		...
		<div class="row" style="margin-bottom:10px">
			<div class="col">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="<?php echo 'bahan' . $i;?>">
					<label class="custom-control-label" for="<?php echo 'bahan' . $i; ?>">
						<div style="width:50px;height:100%">
							<img class="card-img-top" src="data:image/jpeg; base64, <?php echo base64_encode($y[1]); ?>" style="width: 100%;height: 100%;float:left;margin-right:10px;">
						</div>

						<div class="col">
							<span style="float:left"><?php echo $kuantitass[$i]; ?> &nbsp; </span>
							<span style="float:left"><?php echo $jenisberats[$i]; ?> &nbsp; </span>
							<span><?php echo $bahans[$i]; ?></span>
						</div>
					</label>
				</div>
			</div>
			...
			<div class="col-5" style="padding-left:0">
				...
				x
				<input type="text" name="harga" id="harga" value="Rp <?php echo number_format($y[7]); ?>" disabled readonly style="width:70px;font-size:14px;border:none;background-color: white">
	...
	<?php } ?>
		...
		<div class="row">
			<div class="col-1" style="background-color: lightgreen;float:left">
